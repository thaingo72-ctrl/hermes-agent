...
class GatewayConfig:
    ...
    # Session store pruning: drop SessionEntry routing records older than this
    # many days.  Keeps the store from growing unbounded in gateways serving
    # many chats/threads/users over months.  Pruning is invisible to users —
    # if they resume, they get a fresh session exactly as if the reset policy
    # had fired.  0 = disabled.
