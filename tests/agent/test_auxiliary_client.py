...
class TestCodexAuxiliaryAdapterTimeout:
    ...
    def test_enforces_total_timeout_while_stream_keeps_emitting_events(self):
        ...
        class _SlowAliveCreateStream:
            def __iter__(self):
                # Emit one healthy event, then wait until the timeout cleanup
                # worker starts before emitting another. The second event must
                # observe the elapsed deadline and raise without waiting for the
                # deliberately blocked client close below.
