...
def _completion_services():
    from tui_gateway.methods_complete import CompletionServices
...
def _session_cwd(session: dict | None) -> str:
    ...
    return _methods_complete._completion_cwd(None, _completion_services())
...
def _init_session(
    ...
    with _sessions_lock:
        _sessions[sid] = {
            ...
            "attached_images": [],
            "image_counter": 0,
            "cwd": cwd or _methods_complete._completion_cwd(None, _completion_services()),
            "cols": cols,
            "slash_worker": None,
...
# Completion and billing register ordinary callables with explicit services.
...
_methods_complete.register(
    _methods,
    services=_methods_complete.CompletionServices(
        sessions=_sessions,
        hermes_home=lambda: _hermes_home,
        profile_home=_profile_home,
        load_cfg=_load_cfg,
