...
# Config and billing register direct service-injected callables. The remaining
# legacy split modules still use method_ctx.py's globals-rebinding installer
# until their domains are extracted.
...
_methods_config.register(
    ...
    services=_methods_config.ConfigServices(
        ...
        completion_cwd=lambda params=None: _completion_cwd(params),
