...
Hermes 是一个**自主智能体**，运行时间越长，能力越强。你可以将它部署在 5 美元的 VPS、GPU 集群，或闲置时几乎零成本的 Daytona、Modal 等 serverless 基础设施上，并通过 Telegram 与运行在云端的 Hermes 对话。
...
| **[学习路径](/getting-started/learning-path)**                     | 根据你的经验水平找到合适的文档                                     |
| **[配置](/user-guide/configuration)**                              | 配置文件、提供商、模型及选项                                       |
...
| **[语音模式](/user-guide/features/voice-mode)**                    | 在 CLI、Telegram、Discord 及 Discord 语音频道中进行实时语音交互    |
| **[在 Hermes 中使用语音模式](/guides/use-voice-mode-with-hermes)** | Hermes 语音工作流的实操配置与使用模式                              |
...
| **[架构](/developer-guide/architecture)**                          | 底层工作原理                                                       |
